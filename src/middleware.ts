...
export const config = {
  matcher: [
    ...
    '/((?!_next/static|_next/image|favicon\\.ico|apple-icon|icon|opengraph-image|guias|avatars|images|fonts|offline\\.html|manifest\\.json|sw\\.js|workbox-.*\\.js|fallback-.*\\.js).*)',
  ],
}
