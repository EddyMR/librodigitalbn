...
export default async function CatequistaLayout({ children, params }: Props) {
  ...
  if (perfil.rol !== 'catequista') redirect(`/${codigo}/login`)
  ...
  return (
    <div className="min-h-dvh bg-slate-50">
      ...
      <BottomNav codigo={codigo} rol="catequista" />
    </div>
  )
}
