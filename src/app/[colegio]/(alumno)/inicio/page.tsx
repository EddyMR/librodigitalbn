          ...
          <div className="space-y-3">
            {libros.map((libro: any) => {
              ...
              return (
                ...
                >
                  <div className="flex-shrink-0 overflow-hidden rounded-xl bg-brand-100 flex items-center justify-center" style={{ width: 88, height: 116 }}>
                    {libro.portada_url ? (
                      <Image src={libro.portada_url} alt={libro.titulo} width={88} height={116} className="object-cover w-full h-full" />
                    ) : (
